...
///
/// // Query with QueryExpr computation expression
/// let myQuery = query {
///     where &lt;@ fun (u: User) -&gt; u.Age &gt;= 18 @&gt;
///     where &lt;@ fun (u: User) -&gt; u.Active @&gt;
/// }
///
/// // Execute query
...
///
/// Queries are immutable and composable. Use QueryExpr computation expression
/// for ergonomic construction with quotations.
/// </remarks>
///
/// <example>
/// <code>
/// // Single field using DU constructors
...
/// ]
///
/// // Using QueryExpr computation expression with quotations
/// let q = query {
///     where &lt;@ fun (u: User) -&gt; u.Age &gt;= 18 @&gt;
///     where &lt;@ fun (u: User) -&gt; u.Active @&gt;
/// }
...
/// let! results = users |> Collection.find (query { where &lt;@ fun (u: User) -&gt; u.Age &gt;= 18 @&gt; }) None
///
/// // Insert
