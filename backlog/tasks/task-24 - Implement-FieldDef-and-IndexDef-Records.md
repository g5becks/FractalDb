...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 FieldDef has: Name: string, Path: string option, SqlType: SqliteType, Indexed: bool, Unique: bool, Nullable: bool
- [ ] #2 Add IndexDef record type
- [ ] #3 IndexDef has: Name: string, Fields: string list, Unique: bool
...
- [ ] #7 In src/Schema.fs, add FieldDef record type
<!-- AC:END -->
