...
let ``Query nested field with dot notation works`` () =
    task {
        ...
        let user1 = {
            ...
            Age = 30
            Address = { Street = "123 Main St"; City = "New York"; Country = "USA"; ZipCode = "10001" }
            Profile = { Bio = "Developer"; Avatar = Some "avatar1.jpg"; Settings = { Theme = "dark"; Notifications = true; Language = Some "en" } }
        }
        ...
        let user2 = {
            ...
            Age = 25
            Address = { Street = "456 Oak Ave"; City = "San Francisco"; Country = "USA"; ZipCode = "94102" }
            Profile = { Bio = "Designer"; Avatar = None; Settings = { Theme = "light"; Notifications = false; Language = None } }
        }
        ...
        let query = Query.eq "New York" |> Query.field "city"
...
let ``Query deeply nested field (3+ levels) works`` () =
    task {
        ...
        let schema = {
            Fields = [
                { Name = "theme"; Path = Some "$.profile.settings.theme"; SqlType = SqliteType.Text
                  Indexed = true; Unique = false; Nullable = false }
            ]
            Indexes = []
            Timestamps = false
        ...
        let query = Query.eq "dark" |> Query.field "theme"
        let! results = collection |> Collection.find query
...
let ``Update nested field preserves other fields`` () =
    task {
        ...
        | Ok doc ->
            ...
            let updatedUser = {
                doc.Data with
                    Address = { doc.Data.Address with City = "Boston" }
            }
            
            let query = Query.eq doc.Id |> Query.field "_id"
...
let ``Sort by nested field works`` () =
    task {
        ...
        let user1 = {
            ...
            Email = "alice@example.com"
            Age = 30
            Address = { Street = "123 Main St"; City = "Seattle"; Country = "USA"; ZipCode = "98101" }
            Profile = { Bio = "Developer"; Avatar = Some "avatar1.jpg"; Settings = { Theme = "dark"; Notifications = true; Language = Some "en" } }
        }
        ...
        let user2 = {
            ...
            Email = "bob@example.com"
            Age = 25
            Address = { Street = "456 Oak Ave"; City = "Boston"; Country = "USA"; ZipCode = "02101" }
            Profile = { Bio = "Designer"; Avatar = None; Settings = { Theme = "light"; Notifications = false; Language = None } }
        }
        ...
        let user3 = {
            ...
            Age = 35
            Address = { Street = "789 Elm Rd"; City = "Austin"; Country = "USA"; ZipCode = "78701" }
            Profile = { Bio = "Manager"; Avatar = Some "avatar3.jpg"; Settings = { Theme = "dark"; Notifications = true; Language = Some "es" } }
        }
        ...
        let options =
            ...
            |> QueryOptions.sortBy "city" SortDirection.Ascending
        
        let! results = collection |> Collection.findWith (Query.empty<User>) options
...
let ``Query by option field within nested object`` () =
    task {
        ...
        let schema = {
            Fields = [
                { Name = "language"; Path = Some "$.profile.settings.language"; SqlType = SqliteType.Text
        ...
        let query = Query.eq "en" |> Query.field "language"
        let! results = collection |> Collection.find query
